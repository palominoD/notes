    ...
    for i in jresponse['serverResponseObject']:
        ...
        if eventType == "MitigatedVulnerability" :
            try:
                ...
                # If the MitigatedEventDetectionDate is not present, set it to 01 january 2021 in epoch milliseconds
                MitigatedEventDetectionDate = 1609459200000  # 01 January 2021 in epoch milliseconds
        else:
